...
for q=1:2
    ...
    if (q==1)
        plot(ppGpp_PMC(q,:)/ppGpp_PMC(q,1),growthRate_PMC(q,:)/growthRate_PMC(q,1),'k-');
        errorbar(ZD2019_ppGpp_relA/ZD2019_ppGpp_relA(1), ZD2019_Growth_relA/ZD2019_Growth_relA(1), [], [], ZD2019_ppGpp_relA_err/ZD2019_ppGpp_relA(1), ZD2019_ppGpp_relA_err/ZD2019_ppGpp_relA(1), 'ko');
    end
    
    if (q==2)
        index1stzero = find(growthRate_PMC(q,:)==0, 1, 'first');
        plot(ppGpp_PMC(q,1:index1stzero-1)/ppGpp_PMC(q,1),growthRate_PMC(q,1:index1stzero-1)/growthRate_PMC(q,1),'k-');
        plot(ppGpp_PMC(q,index1stzero-1:index1stzero)/ppGpp_PMC(q,1),growthRate_PMC(q,index1stzero-1:index1stzero)/growthRate_PMC(q,1),'k--');
        plot(ppGpp_PMC(q,index1stzero:end)/ppGpp_PMC(q,1),growthRate_PMC(q,index1stzero:end)/growthRate_PMC(q,1),'k-');
        errorbar(ZD2019_ppGpp_mesh/ZD2019_ppGpp_mesh(1), ZD2019_Growth_mesh/ZD2019_Growth_mesh(1), [], [], ZD2019_ppGpp_mesh_err/ZD2019_ppGpp_mesh(1), ZD2019_ppGpp_mesh_err/ZD2019_ppGpp_mesh(1), 'ko');
    end
