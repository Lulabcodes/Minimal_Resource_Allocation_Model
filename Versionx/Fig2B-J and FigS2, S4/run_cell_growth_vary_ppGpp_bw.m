function [AminoAcid,Ribosome,growthRate,ppGppSynRate,ppGppDegRate,IndexLowerLimit,IndexUpperLimit,IndexMaxGrowth] = ...
    run_cell_growth_vary_ppGpp_bw(hp,nutrStar,ppGppList,ppGppStar,initCond,eta,gamma)
...
IndexMaxGrowth  = zeros(1,1);
IndexLowerLimit = zeros(1,1);
IndexUpperLimit = zeros(1,1);
for Flag=0:0
